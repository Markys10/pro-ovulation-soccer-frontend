...
import { predictForDate, getMainCategory, getConfidence } from '../utils/predictions';
...
export default function Index() {
  ...
  const profilesWithPredictions = useMemo(() => {
    return profiles.map(profile => {
      const prediction = predictForDate(today, profile.observaciones);
    ...
    <SafeAreaView style={styles.container} edges={['top']}>
      <View style={styles.header}>
        <View style={styles.brandingRow}>
          <TouchableOpacity onPress={() => router.push('/')} style={styles.titleButton}>
            <Image 
